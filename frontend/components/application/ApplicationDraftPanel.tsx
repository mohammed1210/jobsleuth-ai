  ...
  return (
    <section className="card p-6 space-y-5">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label className="text-sm font-medium text-gray-700">Word limit<input type="number" min={150} max={1500} value={wordLimit} onChange={(e) => setWordLimit(Math.min(1500, Math.max(150, Number(e.target.value) || 500)))} className="mt-1 w-full rounded-xl border px-3 py-2" /></label>
      </div>
