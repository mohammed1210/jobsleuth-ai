...
from routes import ai_scoring, digests, evidence_bank, jobs, resume_tools, saved_jobs, stripe_portal, stripe_routes, stripe_webhook, users, vacancy_intelligence  # noqa: E402
...
app.include_router(evidence_bank.router)
