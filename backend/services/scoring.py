...
def salary_fit(job_salary_min: int | None, job_salary_max: int | None) -> float:
...
def compute_heuristic_score(job: dict[str, Any], resume_text: str | None) -> dict[str, Any]:
...
async def compute_ai_score(job: dict[str, Any], resume_text: str | None) -> dict[str, Any]:
